...
test("WebKit renders critical ES/EN commercial routes without page errors", async ({ page }) => {
...
test("WebKit keeps Home stable at the Phase 8G 768px entry-risk viewport", async ({ page }) => {
  ...
  expect(metrics.scrollWidth, "Home must not overflow horizontally at 768px in WebKit").toBeLessThanOrEqual(
...
test("WebKit mobile navigation traps and restores keyboard focus", async ({ page }) => {
